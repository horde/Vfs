...
class HordeVfsUpgradeNullColumns extends Horde_Db_Migration_Base
{
    public function up()
    {
        $this->changeColumn('horde_vfs', 'vfs_path', 'string', ['limit' => 255, 'null' => true]);
        $this->changeColumn('horde_vfs', 'vfs_owner', 'string', ['limit' => 255, 'null' => true]);
        $this->changeColumn('horde_muvfs', 'vfs_path', 'string', ['limit' => 255, 'null' => true]);
        $this->changeColumn('horde_muvfs', 'vfs_owner', 'string', ['limit' => 255, 'null' => true]);
    ...
    {
        $this->changeColumn('horde_vfs', 'vfs_path', 'string', ['limit' => 255, 'null' => false]);
        $this->changeColumn('horde_vfs', 'vfs_owner', 'string', ['limit' => 255, 'null' => false]);
        $this->changeColumn('horde_muvfs', 'vfs_path', 'string', ['limit' => 255, 'null' => false]);
        $this->changeColumn('horde_muvfs', 'vfs_owner', 'string', ['limit' => 255, 'null' => false]);
